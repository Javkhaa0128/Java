...
single dimensional array: contains multiple data
 ...
 Multi-Dimensional Arrays: array that contains arrays
      n dimensional array contains (n-1) dimension arrays
      ...
      2 dimensional array: contains single dimensional array
          int[][] arr2d = { {1,2,3}, {4,5}, {6,7,8} }   ;
                               ...
                               arr2D[0] ==> {1,2,3}
   Arrays.deepToString(array): converts mutli-D array to String
   Array.toString(array): converts regular array to String
 */

import java.util.Arrays;

public class MulitD_Array {
