 ...
 */
        ...
        students.addAll( Arrays.asList("Javkhlantugs","Muhtar","Noza","Nadir","Asiya"));
        ...
        items.addAll( Arrays.asList("Lexus","House","House","Clothes","Furniture"));
        int count = Collections.frequency(items,"House");
        ...
        for(String each : items){
            int count2 = Collections.frequency(items,each);
            if(count2==1){
                unique.add(each);
            }
        }
