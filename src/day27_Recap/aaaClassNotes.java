...
/*
07/15/2020
Java Recap: Arrays: single & multi-dimensional
            for each loop
...
single dimensional: a variable that contains elemnts (Collection of elements)
    ...
    declare:
        DateType[]  name = {data1, data2, data3..}
                             0       1      2

     initialize size only:
           DateType[]  name = new  DateType[length]
    ...
    Arrays.toString(name): converts array to string
